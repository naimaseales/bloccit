...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  let(:my_sponsored_post) { my_topic.posts.sponsored_posts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph) }
  ...
  describe "PUT update" do
    it "updates sponsored post with expected attributes" do
      ...
      put :update, topic_id: my_topic.id, id: my_sponsored_post, sponsored_post: { title: new_title, body: new_body }
